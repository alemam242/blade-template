                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <p class="fw-medium text-muted mb-0">{{ $task['name'] }}</p>
                                            <h2 class="mt-4 ff-secondary fw-semibold">
                                                <span class="counter-value"
                                                    data-target="{{ $task['task_count'] }}">{{ $task['task_count'] }}
                                                </span>k
                                            </h2>
                                                ...
                                                <td class="assignedto">
                                                    <div class="avatar-group">
                                                        <a href="javascript: void(0);" class="avatar-group-item"
                                                            ...
                                                            data-bs-placement="top" aria-label="Frank"
                                                                        ...
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">James
                                                                                        Forbes</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">John
                                                                                        Robles</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Mary
                                                                                        Gant</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Curtis
                                                                                        Saenz</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Virgie
                                                                                        Price</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Anthony
                                                                                        Mills</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Marian
                                                                                        Angel</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Johnnie
                                                                                        Walton</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Donna
                                                                                        Weston</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div
                                                                                ...
                                                                                <label
                                                                                    ...
                                                                                    <span class="flex-grow-1 ms-2">Diego
                                                                                        Norris</span>
                                                                                </label>
                                                                            </div>
                                                                        </li>
